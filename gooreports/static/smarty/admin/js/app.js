    ...
    jQuery(window).load(function () {
        ...
        jQuery(window).resize(function () {
            window.afterResizeApp && clearTimeout(window.afterResizeApp), window.afterResizeApp = setTimeout(function () {
                window.width = jQuery(window).width(), window.width > 768 ? jQuery("#mobileMenuBtn").removeClass("active") : (jQuery("#mobileMenuBtn").removeClass("active"), jQuery("body").removeClass("menu-open"))
            }, 500)
        })
    })
}
function _scrollTo() {
    jQuery("a.scrollTo").bind("click", function (e) {
        ...
        "#" != t && jQuery("html,body").animate({scrollTop: jQuery(t).offset().top}, 800, "easeInOutExpo")
...
function _ajaxLink(e) {
    e === !0 && jQuery("a").bind("click", function (e) {
        if (jQuery(this).hasClass("external") || "#" == jQuery(this).attr("href") || "javascript:;" == jQuery(this).attr("href") || "javascript:void(0);" == jQuery(this).attr("href") || "javascript:void(0)" == jQuery(this).attr("href"))e.preventDefault(), e.stopPropagation(); else {
            e.preventDefault();
            var t = jQuery(this).attr("href"), t = t.replace("#", "");
...
function _loadPage(e, t) {
    ...
    e = e.replace("#", ""), "" == e && (window.location.hash = "#dashboard.html", e = "dashboard.html"), e = "tpl/" + e, jQuery.ajax({
        ...
        success: function (e) {
            jQuery(t).css({opacity: "0.0"}).html(e).delay(50).animate({opacity: "0.0"}, 0, function () {
                ajaxInit(), jQuery(t).animate({opacity: "1.0"}, 300)
            })
        },
        complete: function () {
            Init(!0)
...
function _owl_carousel() {
    ...
    var total = jQuery("div.owl-carousel").length, count = 0;
    jQuery("div.owl-carousel").each(function () {
        ...
        function buildProgressBar() {
            $progressBar = $("<div>", {id: "progressBar"}), $bar = $("<div>", {id: "bar"}), $progressBar.append($bar).prependTo($elem)
        }
...
function _toggle() {
    ...
    jQuery("div.toggle.active > p").addClass("preview-active"), jQuery("div.toggle.active > div.toggle-content").slideDown(400), jQuery("div.toggle > label").click(function (t) {
        ...
        if (n && "undefined" != typeof t.originalEvent && r.find("div.toggle.active > label").trigger("click"), a.toggleClass("active"), a.find("> p").get(0)) {
            i = a.find("> p");
            var o = i.css("height"), l = i.css("height");
            i.css("height", "auto"), i.css("height", o)
        }
        var s = a.find("> div.toggle-content");
        a.hasClass("active") ? (jQuery(i).animate({height: l}, 350, function () {
            jQuery(this).addClass("preview-active")
        }), s.slideDown(350)) : (jQuery(i).animate({height: e}, 350, function () {
...
function _panels() {
    jQuery("#middle div.panel ul.options>li>a.panel_colapse").bind("click", function (e) {
        e.preventDefault();
        var t = jQuery(this).closest("div.panel"), a = jQuery(this), r = jQuery("div.panel-body", t), i = jQuery("div.panel-footer", t), n = t.attr("id");
        ...
        var e = jQuery(this), t = jQuery("div.panel-body", e), a = jQuery("div.panel-footer", e), r = e.attr("id"), i = localStorage.getItem(r), n = jQuery("a.panel_colapse", e);
        ...
        e.preventDefault();
        var t = jQuery(this).closest("div.panel"), a = t.attr("id");
        ...
        e.preventDefault();
        var t = jQuery(this).closest("div.panel"), a = jQuery("a.panel_close", t).closest("li");
...
!function (e) {
    ...
    var l = "placeholder"in t.createElement("input"), s = "placeholder"in t.createElement("textarea"), u = ":input[placeholder]";
    e.placeholder = {input: l, textarea: s}, !a && l && s ? e.fn.placeholder = function () {
    ...
    def: "easeOutQuad", swing: function (e, t, a, r, i) {
    ...
    e.fn.extend({
        slimScroll: function (a) {
            ...
            return this.each(function () {
                ...
                function n(e, t, a) {
                    v = !1;
                    var i = e, n = j.outerHeight() - w.outerHeight();
                    t && (i = parseInt(w.css("top")) + e * parseInt(r.wheelStep) / 100 * w.outerHeight(), i = Math.min(Math.max(i, 0), n), i = e > 0 ? Math.ceil(i) : Math.floor(i), w.css({top: i + "px"})), y = parseInt(w.css("top")) / (j.outerHeight() - w.outerHeight()), i = y * (j[0].scrollHeight - j.outerHeight()), a && (i = e, e = i / j[0].scrollHeight * j.outerHeight(), e = Math.min(Math.max(e, 0), n), w.css({top: e + "px"})), j.scrollTop(i), j.trigger("slimscrolling", ~~i), s(), u()
                }
                ...
                function l() {
                    m = Math.max(j.outerHeight() / j[0].scrollHeight * j.outerHeight(), 30), w.css({height: m + "px"});
                ...
                if (j.parent().hasClass(r.wrapperClass)) {
                    var Q = j.scrollTop(), w = j.parent().find("." + r.barClass), b = j.parent().find("." + r.railClass);
                    if (l(), e.isPlainObject(a)) {
                        ...
                        if ("scrollTo"in a)Q = parseInt(r.scrollTo); else if ("scrollBy"in a)Q += parseInt(r.scrollBy); else if ("destroy"in a)return w.remove(), b.remove(), void j.unwrap();
                        n(Q, !1, !0)
                    }
                    ...
                    r.height = "auto" == r.height ? j.parent().height() : r.height, Q = e("<div></div>").addClass(r.wrapperClass).css({
                        ...
                        width: r.width,
                        height: r.height
                    }), j.css({overflow: "hidden", width: r.width, height: r.height});
                    var b = e("<div></div>").addClass(r.railClass).css({
                        ...
                        zIndex: 99
                    }), _ = "right" == r.position ? {right: r.distance} : {left: r.distance};
                    ...
                    }), l(), "bottom" === r.start ? (w.css({top: j.outerHeight() - w.outerHeight()}), n(0, !0)) : "top" !== r.start && (n(e(r.start).position().top, null, !0), r.alwaysVisible || w.hide()), o()
                }
            }), this
        }
