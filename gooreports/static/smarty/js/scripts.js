...
function _misc() {
    ...
    e.length > 0 && loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
        function e() {
            _dw = jQuery(document).width(), t.hasClass("fullwidth") ? (_w = t.width(), _wItem = _w / _cols, 760 > _dw && (_wItem = _w / 2), 480 > _dw && (_wItem = jQuery("#portfolio").width()), jQuery("#portfolio>.portfolio-item").css({width: _wItem})) : (_mR = parseInt(jQuery("#portfolio>.portfolio-item").css("margin-right")), _w = jQuery("#portfolio").closest(".container").width(), _wItem = _w / _cols - _mR, 760 > _dw && (_wItem = _w / 2 - _mR), 480 > _dw && (_wItem = _w), jQuery("#portfolio.portfolio-isotope").css({width: _w}), jQuery("#portfolio>.portfolio-item").css({width: _wItem})), jQuery(".flexslider").length > 0 && jQuery(".flexslider").resize()
        }
    ...
    if (t.length > 0 && loadScript(plugin_path + "isotope/isotope.pkgd.min.js", function () {
            function e() {
                _dw = jQuery(document).width(), t.hasClass("fullwidth") ? (_w = jQuery(document).width(), _wItem = _w / _cols, 760 > _dw && (_wItem = _w / 2), 480 > _dw && (_wItem = jQuery("#blog").width()), jQuery("#blog>.blog-post-item").css({width: _wItem})) : (_mR = parseInt(jQuery("#blog>.blog-post-item").css("margin-right")), _w = jQuery("#blog").closest(".container").width(), _wItem = _w / _cols - _mR, 760 > _dw && (_wItem = _w / 2 - _mR), 480 > _dw && (_wItem = _w), jQuery("#blog.blog-isotope").css({width: _w}), jQuery("#blog>.blog-post-item").css({width: _wItem})), jQuery(".flexslider").length > 0 && jQuery(".flexslider").resize()
            }
            ...
            _height1 = jQuery(".box1", this).outerHeight(), _height2 = jQuery(".box2", this).outerHeight(), _height = _height1 >= _height2 ? _height1 : _height2, jQuery(this).css({"min-height": _height + "px"}), jQuery(".box1", this).css({"min-height": _height + "px"}), jQuery(".box2", this).css({"min-height": _height + "px"})
