...
/*(function() {
  Formbuilder.registerField('sex', {
    ...
    view: "<select>\n  <% if (rf.get(Formbuilder.options.mappings.INCLUDE_BLANK)) { %>\n    <option value=''></option>\n  <% } %>\n\n  <% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n    <option <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'selected' %>>\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </option>\n  <% } %>\n</select>",
    edit: "<%= Formbuilder.templates['edit/options']({ includeBlank: true }) %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-caret-down\"></span></span> Sexo",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "Masculino",
...
'\'>\n  <input type="hidden" class=\'js-default-updated\' data-rv-checked="option:checked" />\n  <input type="hidden" data-rv-input="option:id" style="width: 30px"/>\n  <input type="text" data-rv-input="option:value" style="width: 30px"/>\n  <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-option ' +
